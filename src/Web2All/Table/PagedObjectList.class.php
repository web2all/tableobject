...
Web2All_Manager_Main::loadClass('Web2All_Table_ObjectList');

/**
 * Web2All Table Paged ObjectList class
 *
 ...
 *  $result=$this->Web2All->Plugin->Web2All_Table_PagedObjectList($filter);
 ...
 * @since 2008-04-25
 */
class Web2All_Table_PagedObjectList extends Web2All_Table_ObjectList {
  ...
  public function __construct(Web2All_Manager_Main $web2all,$obj) {
    ...
    if (!($obj instanceof $table_countableobject_interface)) {
      throw new Exception('Web2All_Table_PagedObjectList::constructor: requires a '.$table_countableobject_interface.' as param');
    }
